package com.henu.example.com.wechat.main.widget;
...
public class WCPopWindow extends PopupWindow {
    public WCPopWindow(final Activity context, int resId, final OnItemClickListener onItemClickListener) {
