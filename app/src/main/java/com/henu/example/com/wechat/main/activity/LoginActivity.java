...
import com.henu.example.com.wechat.WeChatApplication;
...
//        });
    ...
    private void loginInSever(String tel, String password) {
        ...
        OkHttpManager.getInstance().post(params, WXServer.URL_LOGIN, new OkHttpManager.HttpCallBack() {
            @Override
    ...
    private void loginHuanXin(final JSONObject jsonObject, final ProgressDialog progressDialog) {
        ...
        Helper.getInstance().setCurrentUserName(hxid);
        // call login method
        ...
        EMClient.getInstance().login(hxid, password, new EMCallBack() {
            ...
            public void onSuccess() {
                ...
                WeChatApplication.getInstance().setUserJson(jsonObject);
                // enter main activity
