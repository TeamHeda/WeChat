...
import com.henu.example.com.wechat.main.activity.GroupListActivity;
import com.henu.example.com.wechat.main.activity.NewFriendsActivity;
...
//                        putExtra("userId",FXConstant.FXLIVE_CHATROOM_ID));
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        getActivity().getMenuInflater().inflate(R.menu.wx_context_contact_list, menu);
    }
...
//        }
    ...
    public void deleteContact(final EaseUser tobeDeleteUser) {
        ...
        paramList.add(new Param("hxid_to", Helper.getInstance().getCurrentUsernName()));
        OkHttpManager.getInstance().post(paramList, WXServer.URL_DELETE_FRIEND, new OkHttpManager.HttpCallBack() {
            ...
            public void onResponse(JSONObject jsonObject) {
                ...
                if (code == 1000) {
                    ...
                    Helper.getInstance().getContactList().remove(tobeDeleteUser.getUsername());
...
//        }).start();
    ...
    private void sendCmdDeleteMsg(String hxid) {
        ...
        //action可以自定义
        EMCmdMessageBody cmdBody = new EMCmdMessageBody(WXServer.CMD_DELETE_FRIEND);
