 ...
 */
package com.henu.example.com.wechat.adapter;
...
public class GroupAdapter extends ArrayAdapter<EMGroup> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (getItemViewType(position) == 0) {
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.wx_search_bar_with_padding, parent, false);
			}
			...
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.wx_row_add_group, parent, false);
			}
			((ImageView) convertView.findViewById(R.id.avatar)).setImageResource(R.drawable.wx_create_group);
			((TextView) convertView.findViewById(R.id.name)).setText(newGroup);
		} else if (getItemViewType(position) == 2) {
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.wx_row_add_group, parent, false);
			}
			((ImageView) convertView.findViewById(R.id.avatar)).setImageResource(R.drawable.wx_add_public_group);
			...
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.wx_row_group, parent, false);
			}
