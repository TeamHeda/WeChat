...
import com.henu.example.com.wechat.db.DemoDBManager;
import com.henu.example.com.wechat.db.InviteMessgeDao;
import com.henu.example.com.wechat.db.UserDao;
import com.henu.example.com.wechat.domain.EmojiconExampleGroupData;
import com.henu.example.com.wechat.domain.InviteMessage;
import com.henu.example.com.wechat.domain.RobotUser;
import com.henu.example.com.wechat.main.activity.MainActivity;
import com.henu.example.com.wechat.receiver.CallReceiver;
import com.henu.example.com.wechat.ui.ChatActivity;
import com.henu.example.com.wechat.ui.VideoCallActivity;
import com.henu.example.com.wechat.ui.VoiceCallActivity;
import com.henu.example.com.wechat.utils.PreferenceManager;
...
public class Helper {
    ...
    private EMOptions initChatOptions(){
        ...
        if(Model.isCustomServerEnable() && Model.getRestServer() != null && Model.getIMServer() != null) {
            options.setRestServer(Model.getRestServer());
            options.setIMServer(Model.getIMServer());
            if(Model.getIMServer().contains(":")) {
                options.setIMServer(Model.getIMServer().split(":")[0]);
                options.setImPort(Integer.valueOf(Model.getIMServer().split(":")[1]));
            }
        }

        if (Model.isCustomAppkeyEnabled() && Model.getCutomAppkey() != null && !Model.getCutomAppkey().isEmpty()) {
            options.setAppKey(Model.getCutomAppkey());
        }
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactDeleted(String username) {
            Map<String, EaseUser> localUsers = Helper.getInstance().getContactList();
        ...
        new Thread(){
            ...
            public void run(){
                try {
                    ...
                    Model.setBlacklistSynced(false);
